export enum EmailEventType { BookingConfirmed = 'BOOKING_CONFIRMED', BookingCancelled = 'BOOKING_CANCELLED', BookingRefundRequired = 'BOOKING_REFUND_REQUIRED', PurchaseCustomer = 'PURCHASE_CUSTOMER', PurchaseAdmin = 'PURCHASE_ADMIN' }
